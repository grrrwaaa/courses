...
[Final projects google doc](https://docs.google.com/document/d/1_gRshxJ3okTv0ntoa-_3kIqzgqwKZY8qTuicOCxOS-k/edit)

We should be giving our final presentations and demonstrations on Mar 30. (I hope you will continue to work on your projects beyond the course!)

I advise being ready to give screening/alpha-test/playtest two weeks prior, on Mar 16. This will give two weeks to iron out final production. 

### Groups

For group projects, there are different ways to break up roles. One way is to assign different physical areas of a world to different people. Another way is to break up into small tasks that people can take on. Another is to adopt responsibility- or capability-based roles, such as Design (concept, story, mechanics, other directorial), Art asset creation (visual, sonic, spatial, etc.),  Engineering (implementation of mechanics, etc.), and so forth.


### General

In terms of solidifying a project, it can be helpful to respond to specific questions, such as:

- How do you contextualize the project? Original artspaces as an experience to navigate through? Unique games with rules in a reward oriented manner? What are the hooks? (Easily graspable and seductive uniqueness), Does it flip expectations? What metaphors, allusions, poetics of space or time?
...
- Is it for a viewer/audience/participant/immersant/user/etc.?
...
What moves in the world -- what makes it more than a place? Or, is absence/loss part of its character?
...
- What will you do about [simulator sickness](perception.html)
