...
var phero_green = new field2D(256);
var phero_green_old = phero_green.clone();
var phero_red = new field2D(200);
var phero_red_old = phero_red.clone();
var phero_blue = new field2D(192);
var phero_blue_old = phero_blue.clone();

var phero_diffuse = 0.03;
var phero_decay = 0.997;
